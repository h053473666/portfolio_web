                                ...
                                <div class="section-below-the-fold">
                                    <div class="home-category-list">
                                        <div class="shopee-header-section shopee-header-section--simple">
                                            ...
                                            <div class="KNQorU" style="padding-top: 40px;padding-bottom: 40px;"><h1 class="gpbev8">相似商品</h1><hr class="k68Wl1"></div>
                                            ...
                                            <div class="shopee-page-controller">
                                                <c:if test="${page==0}">
                                                    ...
                                                    <button class="shopee-button-no-outline" onclick="window.location.href='${pageContext.request.contextPath}/similar/${itemId}/${page+1}'">2</button>
                                                    <button class="shopee-button-no-outline" onclick="window.location.href='${pageContext.request.contextPath}/similar/${itemId}/${page+2}'">3</button>
                                                    <button class="shopee-icon-button shopee-icon-button--right " onclick="window.location.href='${pageContext.request.contextPath}/similar/${itemId}/${page+1}'"><svg enable-background="new 0 0 11 11" viewBox="0 0 11 11" x="0" y="0" class="shopee-svg-icon icon-arrow-right"><path d="m2.5 11c .1 0 .2 0 .3-.1l6-5c .1-.1.2-.3.2-.4s-.1-.3-.2-.4l-6-5c-.2-.2-.5-.1-.7.1s-.1.5.1.7l5.5 4.6-5.5 4.6c-.2.2-.2.5-.1.7.1.1.3.2.4.2z"></path></svg></button>
                                                </c:if>

                                                <c:if test="${page==1}">
                                                    <button class="shopee-icon-button shopee-icon-button--left " onclick="window.location.href='${pageContext.request.contextPath}/similar/${itemId}/${page-1}'">
                                                        <svg enable-background="new 0 0 11 11" viewBox="0 0 11 11" x="0" y="0" class="shopee-svg-icon icon-arrow-left"><g><path d="m8.5 11c-.1 0-.2 0-.3-.1l-6-5c-.1-.1-.2-.3-.2-.4s.1-.3.2-.4l6-5c .2-.2.5-.1.7.1s.1.5-.1.7l-5.5 4.6 5.5 4.6c.2.2.2.5.1.7-.1.1-.3.2-.4.2z"></path></g></svg></button>
                                                    <button class="shopee-button-no-outline" onclick="window.location.href='${pageContext.request.contextPath}/similar/${itemId}/${page-1}'" >1</button>
                                                    <button class="shopee-button-solid shopee-button-solid--primary" >2</button>
                                                    <button class="shopee-button-no-outline" onclick="window.location.href='${pageContext.request.contextPath}/similar/${itemId}/${page+1}'">3</button>
                                                    <button class="shopee-icon-button shopee-icon-button--right " onclick="window.location.href='${pageContext.request.contextPath}/similar/${itemId}/${page+1}'"><svg enable-background="new 0 0 11 11" viewBox="0 0 11 11" x="0" y="0" class="shopee-svg-icon icon-arrow-right"><path d="m2.5 11c .1 0 .2 0 .3-.1l6-5c .1-.1.2-.3.2-.4s-.1-.3-.2-.4l-6-5c-.2-.2-.5-.1-.7.1s-.1.5.1.7l5.5 4.6-5.5 4.6c-.2.2-.2.5-.1.7.1.1.3.2.4.2z"></path></svg></button>
                                                </c:if>
                                                ...
                                                <c:if test="${page==2}">
                                                    <button class="shopee-icon-button shopee-icon-button--left " onclick="window.location.href='${pageContext.request.contextPath}/similar/${itemId}/${page-1}'">
                                                        <svg enable-background="new 0 0 11 11" viewBox="0 0 11 11" x="0" y="0" class="shopee-svg-icon icon-arrow-left"><g><path d="m8.5 11c-.1 0-.2 0-.3-.1l-6-5c-.1-.1-.2-.3-.2-.4s.1-.3.2-.4l6-5c .2-.2.5-.1.7.1s.1.5-.1.7l-5.5 4.6 5.5 4.6c.2.2.2.5.1.7-.1.1-.3.2-.4.2z"></path></g></svg></button>
                                                    <button class="shopee-button-no-outline" onclick="window.location.href='${pageContext.request.contextPath}/similar/${itemId}/${page-2}'">1</button>
                                                    <button class="shopee-button-no-outline" onclick="window.location.href='${pageContext.request.contextPath}/similar/${itemId}/${page-1}'">2</button>
